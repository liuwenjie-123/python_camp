...
# pyautogui.screenshot('kar.png')
imgCoordinate = pyautogui.locateCenterOnScreen('1.png')
pyautogui.click(imgCoordinate)
print(imgCoordinate)
time.sleep(1)
imgCoordinate = pyautogui.locateCenterOnScreen('2.png')
pyautogui.click(imgCoordinate)
